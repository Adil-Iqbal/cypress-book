...
* Check the contents of a warning alert and close it.

* Type in a username and password and submit.

* Fill out a form, with radio and check box, and submit.

* Check whether the url contains a specific keyword.

* Clicking on a button should generate and error, check for it.

* Click the link on the third row of the table.

* Click button before, after, before each, and after each.
